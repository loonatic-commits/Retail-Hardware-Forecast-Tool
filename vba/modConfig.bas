...
Public Const LEGEND_ANCHOR_CELL As String = "Q1"
...
Public Sub InitColors()
    ...
    CLR_SOF_HIGH = RGB(146, 208, 80)               ' bright green - Pass 2 was > SOF by 20%+
    CLR_SOF_LOW = RGB(244, 176, 132)               ' light peach - Pass 2 was < SOF by 20%+

    CLR_SOFAR_UPGRADE = RGB(0, 176, 80)            ' strong green - current month tracking ahead
    CLR_SOFAR_DOWNGRADE = RGB(237, 125, 49)        ' strong orange - current month tracking behind
                                                   ' (orange so red inventory-constrained font stays readable)
